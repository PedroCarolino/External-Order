...
void copia_arquivo(char *menor,int n_caracteres,FILE *entrada,FILE* saida);
void  ordena_subarquivo(char *menor,char **matriz_palavras,int n_caracteres,int n_real);
void ordena_arquivo(FILE *saida,FILE *arq1,FILE *arq2,char **matriz_palavras1,char **matriz_palavras2,int n,int n_caracteres);
